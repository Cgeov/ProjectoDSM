...
public class updateRegist extends AppCompatActivity {
    EditText salarioB;
    EditText tipoSal;
    EditText tiempo;
    EditText ISSS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_regist);
        ...
        DbRegistros dbRegistros = new DbRegistros(updateRegist.this);
        Bundle recept = getIntent().getExtras();
        int id = recept.getInt("id");
        ...
        if(recept != null){
            ...
            correcto = dbRegistros.UpdateReg(id,name,area,tipo,salarioB.getText().toString(),descT.getText().toString(),
        ...
        btnAddMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(updateRegist.this, Calculadora.class);
        ...
        btnViewRecord.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(updateRegist.this, Records.class);
                startActivity(intent);
            }
        });
